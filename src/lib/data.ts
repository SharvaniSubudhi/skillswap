...
export const sessions: Session[] = [
    {
        ...
        googleMeetLink: '#',
        status: 'scheduled',
        sessionDate: new Date(new Date().setDate(new Date().getDate() + 3)),
        disputeRaised: false,
    },
    {
        id: 's2',
        ...
        googleMeetLink: '#',
        status: 'completed',
        sessionDate: new Date(new Date().setDate(new Date().getDate() - 5)),
    ...
    },
    {
        ...
        googleMeetLink: '#',
        status: 'cancelled',
        sessionDate: new Date(new Date().setDate(new Date().getDate() - 2)),
        disputeRaised: false,
    },
    {
        id: 's4',
        ...
        googleMeetLink: '#',
        status: 'completed',
        sessionDate: new Date(new Date().setDate(new Date().getDate() - 10)),
